        ...
        (incoming: Track[]) => {
            ...
            setDisplayTracks((prev) => {
                ...
                if (merged.length) {
                    ...
                    const nextActive =
                        merged[activeIndex >= 0 ? activeIndex : 0];
                    setCurrentTrack(
                        nextActive,
                        merged,
            ...
            <div className="px-5 md:px-10 pt-10 pb-6 flex flex-col gap-6 md:flex-row md:items-end">
                ...
                <div className="flex items-center gap-3">
                    <PlayButton
                        ...
                        onClick={() =>
                            displayTracks[0] &&
                            handlePlayTrack(displayTracks[0], 0)
                        }
                        className={
                            displayTracks[0] &&
                        ...
                        >
                            ...
                            >
                                <div className="text-zinc-400 text-sm md:text-left flex items-center gap-2">
                                    ...
                                    {isCurrent && isPlaying && (
                                        <span className="text-green-400 font-semibold text-[10px] uppercase tracking-wide">
                                            Now Playing
                                        </span>
                                    )}
                                </div>
