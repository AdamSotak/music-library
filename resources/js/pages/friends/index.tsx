				...
				<div className="mb-8">
					...
					<div className="relative">
						<div className="flex items-center bg-zinc-800 rounded-lg px-4 py-3">
							...
							/>
							{isSearching && (
								<div className="ml-3 animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
							)}
						</div>

						{/* Search Results */}
						{searchResults.length > 0 && (
							<div className="absolute top-full left-0 right-0 bg-zinc-800 rounded-lg mt-2 max-h-96 overflow-y-auto z-10">
								{searchResults.map((user) => (
									<div
										key={user.id}
										className="flex items-center justify-between p-4 hover:bg-zinc-700 border-b border-zinc-700 last:border-b-0"
									>
										<div>
