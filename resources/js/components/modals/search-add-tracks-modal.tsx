...
export const SearchAddTracksModal = ({ playlistId, isOpen, onClose }: SearchAddTracksModalProps) => {
	...
	return (
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="bg-zinc-900 border-none max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
				<DialogHeader>
					<DialogTitle className="text-2xl font-bold">Let's find something for your playlist</DialogTitle>
				</DialogHeader>
