...
export function JamModal({ currentUserName }: { currentUserName: string | null }) {
            ...
            >
                <DialogHeader className="pb-2">
                    ...
                    <DialogDescription className="text-zinc-400">
                        Listen together in real time. Share the link or QR code to let others join.
                    </DialogDescription>
                </DialogHeader>

                <div className="space-y-4 overflow-y-auto pr-1" style={{ scrollbarWidth: "thin" }}>
                    ...
                    <div className="flex items-center gap-2 text-sm text-zinc-300">
                        ...
                        {status === "error" && (
                            <span className="inline-flex items-center gap-2 text-red-400">
                                <WifiOff className="w-4 h-4" /> WebSocket unavailable (falling back locally)
                            </span>
                        )}
                    </div>
