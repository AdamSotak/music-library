...
export default function SimpleAudioPlayer() {
	...
	return (
		<div className="w-full h-20 px-4 bg-black border-t border-zinc-800">
			<audio
				ref={audioRef}
			...
			<div className="flex justify-between items-center w-full h-full">
				...
				<div className="flex items-center gap-2 flex-1 min-w-0">
					<img
						src={currentTrack.album_cover || `https://placehold.co/48x48/333/white?text=T`}
						alt="Album cover"
				...
				<div className="flex items-center gap-4">
					<Button size="icon" variant="spotifyTransparent" className="group w-4 h-4">
						<svg
							role="img"
							aria-hidden="true"
							viewBox="0 0 16 16"
